...
1. Wysłanie żądanie dostępu do strony internetowej z opiniami o produkcie
...
4. Jeśli istnieje kolejna strona z opiniami, przejście do niej i powtarzamy dla nej kroków 1-4
...
|Następna strona|next_page|a.pagination__next|
